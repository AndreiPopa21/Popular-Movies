...
public class TrailerLinksAsyncTaskLoader extends AsyncTaskLoader<String>{

    private Bundle bundle;
    private String cachedData;

    public TrailerLinksAsyncTaskLoader(Context context,Bundle bundle) {
        super(context);
        this.bundle=bundle;
    }
    ...
    public String loadInBackground() {
        URL url = null;
        try {
            url = new URL(bundle.getString(MovieDetailActivity.LOADER_TRAILER_URL_KEY));
